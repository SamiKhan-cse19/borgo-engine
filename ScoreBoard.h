...
namespace borgo
{
	...
	protected:
		...
		* helper methods for drawing lines to Scoreboard
		*/
	...
	public:
		...
		/**
		* Overloaded update method of Block_base class
		* Update the contents of texture
		*/
		void update();

		// Exceptions
		class MapWidthExceeded
		{};

		/**
		* Adding, editing and getting scores
		* 
		* Adding score to list with or without index
		* Adding list of scores
		* Getting score by key or index
		* Editting score by key or index
		*/
		...
		/**
		* Clear all score items and Maps
		*/
		void clearBoard();
